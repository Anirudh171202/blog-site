...
summary: (Part 1) BPE Tokenizers under the hood, and where tokenization breaks math, spelling and code
date: '2026-04-05'
tags: ['AI', 'Computer Science', 'NLP']
draft: false
---
<div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem' }}>
  <span style={{ background: '#6366f1', color: 'white', padding: '2px 10px', borderRadius: '999px', fontSize: '0.8rem', fontWeight: 600 }}>Part 1 of 3</span>
  <span style={{ background: '#e5e7eb', color: '#374151', padding: '2px 10px', borderRadius: '999px', fontSize: '0.8rem' }}>5 min read</span>
</div>
