...
summary: (Part 3) Sampling strategies and why inference optimizations pose a security tradeoff
date: '2026-04-07'
tags: ['AI', 'Computer Science', 'Security']
draft: false
---
<div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem' }}>
  <span style={{ background: '#6366f1', color: 'white', padding: '2px 10px', borderRadius: '999px', fontSize: '0.8rem', fontWeight: 600 }}>Part 3 of 3</span>
  <span style={{ background: '#e5e7eb', color: '#374151', padding: '2px 10px', borderRadius: '999px', fontSize: '0.8rem' }}>7 min read</span>
</div>
